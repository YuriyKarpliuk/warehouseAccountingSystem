...
public class MySupplyTransactionsController implements Initializable {
    @FXML
    private TableView<TransactionRowData> mySuppliesTable;
    ...
    @FXML
    private TableColumn<TransactionRowData, Integer> priceByOne;
    ...
    @FXML
    private TableColumn<TransactionRowData, Integer> code;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        connection.sendMessage("mySupplyList");
    ...
    public void updateTable() {
        ...
        priceByOne.setCellValueFactory(new PropertyValueFactory<>("price"));
        ...
        mySuppliesTable.setItems(filteredList);
    }
